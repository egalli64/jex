...
class Reverse3Test {
    public static Stream<Arguments> provider() {
        return Stream.of( //
                ...
                Arguments.of(new int[] { 5, 11, 9 }, new int[] { 9, 11, 5 }), //
    ...
    public void solutionExamples(int[] input, int[] expected) {
        assertThat(Reverse3.solution(input)).isEqualTo(expected);
    }

    @ParameterizedTest
    @MethodSource("provider")
    public void robustnessExamples(int[] input, int[] expected) {
        assertThat(Reverse3.robustness(input)).isEqualTo(expected);
    }
}
